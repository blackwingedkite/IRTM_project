...
"""
Hit Rate: 0.9504723733180647
MRR: 0.8311575532016422
"""
...
# 查詢資料
response = supabase.table('drcd_questions').select('dataset_id, similar_doc_ids_tfidf, paragraph_id').execute()
